...
const PlaceHolder = () => {
  ...
  const { getSubTotal, food_list, cartItem, url, token } = useContext(StoreContext)
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-10">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <input name="zipcode" onChange={handleChange} placeholder="Zipcode" className="w-full border pl-3 h-10" />
